...
export function ResumePreview({ file, data, onDelete, resumeId }) {
    ...
    const API_ROOT = (import.meta.env.VITE_API_URL || 'https://navigate-ai-backend.onrender.com/api').replace(/\/api$/, '');
    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 flex flex-col h-[500px] hover:shadow-md transition-all group/card overflow-hidden">
            ...
            <div className="p-4 border-t border-slate-100 bg-slate-50 flex gap-2">
                <button
                    ...
                    className="flex-1 py-2 px-3 bg-white border border-slate-200 hover:border-blue-500 hover:text-blue-600 text-slate-600 rounded-lg text-xs font-bold transition-all shadow-sm flex items-center justify-center gap-2"
                ...
                <button
                    ...
                    className="flex-[2] py-2 px-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-bold uppercase tracking-wider transition-all shadow-sm flex items-center justify-center gap-2"
                >
                ...
                <button
                    onClick={onDelete}
                    className="py-2 px-3 bg-white border border-slate-200 hover:bg-red-50 hover:border-red-500 hover:text-red-600 text-slate-400 rounded-lg transition-all shadow-sm flex items-center justify-center"
                    title="Delete Resume"
                >
